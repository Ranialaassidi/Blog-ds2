...
try {
    $stmt = $pdo->prepare("SELECT messages.message, users.id, messages.created_at 
                           FROM messages 
                           INNER JOIN users 
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="article.php">Return</a>
                </li>
            </ul>
        </div>
    </div>
                ...
                <div class="card-body">
                    <?php foreach ($messages as $message) : ?>
                        <div class="message-container">
                            <strong>Anonyme <?php echo $message['id']; ?>:</strong>
